...
import '../SuiteInfo/SuiteInfo.scss';
    ...
    return (
        <section className="suiteinfo">
          <div className="suiteinfo__container">
            ...
            <img className='suiteinfo__img' src={stock1} alt="bedding" />
            ...
            <img className='suiteinfo__img' src={stock4} alt="bedding" />
            ...
            <img className='suiteinfo__img' src={stock3} alt="bedding" />
